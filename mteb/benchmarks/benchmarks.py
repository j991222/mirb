...
MIRB = Benchmark(
    ...
    description="MIRB: Mathematical Information Retrieval Benchmark",
    reference="https://huggingface.co/collections/hcju/mirb-6827001711765454f58c5a76",
    citation="""@article{ju2025mirb,
