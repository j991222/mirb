...
gte_large_en_v1_5 = ModelMeta(
    ...
    open_weights=True,
    revision="104333d6af6f97649377c2afbde10a7704870c7b",
    release_date="2024-08-09",  # initial commit of hf model.
    n_parameters=434_000_000,
    memory_usage=None,
    embed_dim=1024,
    license="mit",
    max_tokens=8192,
    reference="https://huggingface.co/Alibaba-NLP/gte-large-en-v1.5",
    similarity_fn_name="cosine",
    framework=["Sentence Transformers", "PyTorch"],
